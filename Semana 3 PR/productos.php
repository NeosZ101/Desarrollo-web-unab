...
<body class="d-flex flex-column min-vh-100">
  ...
  <!-- Seccion dinámica de javascript -->
  <div class="container my-5 flex-grow-1">
    <h2 class="text-blood border-bottom border-secondary pb-2 mb-4">Catálogo de Reseñas</h2>
    <p class="text-light">Carga nuestra base de datos de juegos evaluados.</p>

    <!-- Evento javascript: onclick -->
    <div class="text-center">
      <button id="btn-cargar" class="btn btn-blood rounded-0 px-4 py-2 mb-4" onclick="cargarResenas()">
        <i class="bi bi-cloud-arrow-down me-2"></i>Cargar Reseñas Dinámicas
      </button>
    </div>

    <!-- Contenedor vacío donde el DOM inyectará las tarjetas -->
    <div id="contenedor-resenas" class="row"></div>
  </div>
