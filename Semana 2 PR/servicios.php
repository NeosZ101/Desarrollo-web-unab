...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item"><a class="nav-link active" href="servicios.php"><i class="bi bi-hdd-network me-1 text-blood"></i>Servicios</a></li>
  ...
  <div class="container my-5 flex-grow-1">
    <h1 class="text-blood border-bottom border-secondary pb-2 mb-4">Servicios</h1>
    <p class="lead text-light">Revisa los servicios que ofrecemos para la comunidad y creadores:</p>

    <div class="row g-4 mt-3 text-center">
      <div class="col-md-4">
        <div class="card card-dark h-100 p-4 rounded-0 shadow">
          <h4 class="text-white mb-3">Cobertura de Eventos</h4>
          <p class="text-light small">Redacción de artículos sobre convenciones de gaming .</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card card-dark h-100 p-4 rounded-0 shadow">
          <h4 class="text-white mb-3">Análisis de Indies</h4>
          <p class="text-light small">Damos visibilidad a juegos independientes con reseñas detalladas para apoyar a nuevos creadores.</p>
        </div>
      </div>
      <div class="col-md-4">
        <div class="card card-dark h-100 p-4 rounded-0 shadow">
          <h4 class="text-white mb-3">Guías y Walkthroughs</h4>
          <p class="text-light small">Creación de contenido estratégico.</p>
        </div>
      </div>
    </div>
  </div>
