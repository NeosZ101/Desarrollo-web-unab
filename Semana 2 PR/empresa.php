...
<head>
  ...
  <style>
    ...
    /* Colores personalizados (Rojo sangre y grises oscuros) */
...
<body class="d-flex flex-column min-vh-100">
  ...
  <div class="container my-5 flex-grow-1">
    <h1 class="text-blood mb-2 border-bottom border-secondary pb-2">El Proyecto</h1>
    <h2 class="mb-4 text-light">Acerca del Blog</h2>
    <p class="lead mb-5 text-light">Conoce más sobre la historia, misión y el equipo detrás de este espacio dedicado a los videojuegos.</p>
    
    <div class="row g-4 mt-2">
      <div class="col-md-6">
        <div class="card card-dark h-100 p-4 rounded-0 shadow">
          <h3 class="text-white">Nuestra Misión</h3>
          <p class="mt-3 text-light">Brindar información de calidad, reseñas honestas y mantener a la comunidad gamer informada sobre las últimas tendencias de la industria.</p>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card card-dark h-100 p-4 rounded-0 shadow">
          <h3 class="text-white">Nuestro Equipo</h3>
          <p class="mt-3 text-light">Este proyecto es mantenido por <strong>Pablo Labra</strong> (Github: <a href="https://github.com/NeosZ101/Desarrollo-web-unab" class="text-blood text-decoration-none" target="_blank">NeosZ101</a>).</p>
        </div>
      </div>
    </div>
  </div>
